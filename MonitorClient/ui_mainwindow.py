...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy2.setHeightForWidth(self.groupProfile.sizePolicy().hasHeightForWidth())
        self.groupProfile.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.tableProfiles.sizePolicy().hasHeightForWidth())
        self.tableProfiles.setSizePolicy(sizePolicy2)
        ...
        icon1 = QIcon()
        icon1.addFile(u"../../../../.designer/icons/left_rotation.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u"../../../../.designer/icons/right_rotation.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u"../../../../.designer/icons/vertical_flip.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u"../../../../.designer/icons/horizontal_flip.png", QSize(), QIcon.Normal, QIcon.Off)
