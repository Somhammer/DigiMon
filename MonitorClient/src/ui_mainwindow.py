...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        font.setBold(False)
        self.checkConnectCamera.setFont(font)
        ...
        self.checkConnectController.setFont(font)
        ...
        sizePolicy2.setHeightForWidth(self.textLog.sizePolicy().hasHeightForWidth())
        self.textLog.setSizePolicy(sizePolicy2)
        self.textLog.setMaximumSize(QSize(16777215, 150))

        self.gridLayout_3.addWidget(self.textLog, 8, 0, 1, 2)
        ...
        font1.setBold(True)
        self.groupProfile.setFont(font1)
        ...
        self.tableProfiles.setFont(font)
        ...
        self.lineFieldGradient.setFont(font)
        ...
        self.pushEmittance.setFont(font)
        ...
        self.gridLayout_3.addWidget(self.groupProfile, 6, 0, 1, 2)
        ...
        self.gridLayout_3.addLayout(self.gridCapture, 4, 0, 1, 2)
        ...
        sizePolicy4.setHeightForWidth(self.groupControl.sizePolicy().hasHeightForWidth())
        self.groupControl.setSizePolicy(sizePolicy4)
        self.groupControl.setFont(font1)
        ...
        self.labelRepeatRange.setFont(font)
        ...
        self.labelFrameRate.setFont(font)
        ...
        self.lineFrameRate.setFont(font)
        ...
        self.labelFrameRange.setFont(font)
        ...
        self.pushRotateRight.setFont(font)
        icon1 = QIcon()
        ...
        self.labelRotation.setFont(font)
        ...
        self.pushFlipUpDown.setFont(font)
        icon3 = QIcon()
        ...
        self.gridLayout_3.addWidget(self.groupControl, 5, 0, 1, 2)
        ...
        self.gridLayout_4 = QGridLayout(self.frameLiveYProfile)
        self.gridLayout_4.setObjectName(u"gridLayout_4")
        self.gridLayout_4.setHorizontalSpacing(0)
        self.gridLayout_4.setContentsMargins(0, 0, 0, 0)
        self.labelLiveYProfile = QLabel(self.frameLiveYProfile)
        self.labelLiveYProfile.setObjectName(u"labelLiveYProfile")

        self.gridLayout_4.addWidget(self.labelLiveYProfile, 0, 0, 1, 1)
        ...
        self.labelLiveXProfile = QLabel(self.frameLiveXProfile)
        self.labelLiveXProfile.setObjectName(u"labelLiveXProfile")

        self.gridLiveXProfile.addWidget(self.labelLiveXProfile, 0, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelLiveYProfile.setText("")
        self.labelLiveXProfile.setText("")
